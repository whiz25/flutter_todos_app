...
void main() {
  ...
  setUp(() async {
    ...
    todoList = await todoRepository
        .addTodoList(TodoList(id: Uuid().v4(), title: 'Test List'));
  });
  ...
  test('Test updateTodo()', () async {
    ...
    final updatedTodo = existingTodo.copyWith(content: 'Code in Python');
    await todoRepository.updateTodo(todoList, updatedTodo);
